...
class ActiveReportWc extends StatefulWidget {
  const ActiveReportWc({super.key});

  @override
  State<ActiveReportWc> createState() => _ActiveReportWcState();
}

class _ActiveReportWcState extends State<ActiveReportWc> {
  ...
  @override
  void dispose() {
    dcCntrlr.activeReportWc.clear(); // Clear the report list
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    await dcCntrlr.activeReportwcData(
                ...
                // Result Section
                Obx(() {
                  if (dcCntrlr.activeReportWc.isEmpty) {
                    return Column(
                      children: [
                        SizedBox(
                          height: 6.h,
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildTableHeader(),
                            ...List.generate(
                              dcCntrlr.activeReportWc.length,
                                  ...
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => FullView(
                                                hpl: dcCntrlr
                                                    .activeReportWc[index].hpl,
                                                loantype: dcCntrlr
                                                    .activeReportWc[index]
                                                    .loantype,
                                              )));
                                },
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        _TableCell(
                                          text: dcCntrlr
                                                  .activeReportWc[index].name ??
                                              'N/A',
                                        ),
                                        _TableCell(
                                          text: dcCntrlr.activeReportWc[index]
                                                  .hpdate ??
                                              'N/A',
                                        ),
                                        _TableCell(
