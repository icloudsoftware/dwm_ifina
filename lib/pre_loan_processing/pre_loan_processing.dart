...
class PreLoanProccessing extends StatefulWidget {
  const PreLoanProccessing({super.key});

  @override
  State<PreLoanProccessing> createState() => _PreLoanProccessingState();
}

class _PreLoanProccessingState extends State<PreLoanProccessing> {
  ...
  var preloancntrlr = Get.put(PreProcessingController());
                          ...
                          GestureDetector(
                            onTap: () async {
                              Map<String, dynamic> data = {
                                ...
                                // "address1": "Street 1",
                                // "address2": "Street 2",
                                // "oaddress1": "Other Addr 1",
                                // "oaddress2": "Other Addr 2",
                                // "co01": "Co-Applicant 1",
                                // "co02": "Co-Applicant 2",
                                // "co201": "CO 201",
                                // "co202": "CO 202",
                              ...
                              logger.w(data);
                              await preloancntrlr.preProcessingLoan(data: data);
                            },
                            child: Container(
