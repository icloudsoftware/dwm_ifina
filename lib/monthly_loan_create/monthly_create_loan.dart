...
class MonthlyCollections extends StatefulWidget {
  const MonthlyCollections({super.key});

  @override
  State<MonthlyCollections> createState() => _MonthlyCollectionsState();
}
                        ...
                        if (_currentStep == 2)
                          GestureDetector(
                            onTap: () async {
                              ...
                              logger.w(data);
                              await createLoanController.createMonthlyLoan(
                                  data: data);
                            },
                            child: Container(
