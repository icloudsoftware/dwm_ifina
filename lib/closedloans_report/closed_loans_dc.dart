...
class ClosedLoansDc extends StatefulWidget {
  const ClosedLoansDc({super.key});

  @override
  State<ClosedLoansDc> createState() => _ClosedLoansDcState();
}

class _ClosedLoansDcState extends State<ClosedLoansDc> {
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    await closedCntrlr.closdeLoansDc(
