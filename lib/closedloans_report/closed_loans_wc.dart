...
class ClosedLoansWc extends StatefulWidget {
  const ClosedLoansWc({super.key});

  @override
  State<ClosedLoansWc> createState() => _ClosedLoansWcState();
}

class _ClosedLoansWcState extends State<ClosedLoansWc> {
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    await closedCntrlr.closdeLoansWc(
